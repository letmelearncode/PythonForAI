...
# REVISED DATE: 05/14/2020 - added import statement that imports the print
...
def main():
    ...
    # Define get_pet_labels() function to create pet image labels by
    ...
    # Define adjust_results4_isadog() function to adjust the results
    # dictionary(result_dic) to determine if classifier correctly classified
    # images as 'a dog' or 'not a dog'. This demonstrates if the model can
    # correctly classify dog images as dogs (regardless of breed)
    adjust_results4_isadog(results_dic, in_arg.dogfile)

    # Define calculates_results_stats() function to calculate
    # results of run and puts statistics in a results statistics
    # dictionary (results_stats_dic)
    results_stats_dic = calculates_results_stats(results_dic)

    # Define print_results() function to print summary results,
...
def get_pet_labels(image_dir):
    ...
    for file in in_files:
        if file.startswith('.'):
            print('Incorrect file found in image directory {}'.format(image_dir))
        else:
            pet_label = ''
...
def classify_images(images_dir, petlabel_dic, model):
    ...
    for key in petlabel_dic:
        ...
        # classifier function inputs: path + filename  and  model,
